...
import com.jena.model.RDFLoad10000;
import com.vaannila.protein.MySQLMatrix10000;
import com.vaannila.protein.MySQLMatrix6000;
import com.vaannila.protein.Protein;

public class MarkovClustering10000 {
	/**
	...
	public static long methodA() {
		...
		double[][] a = RDFLoad10000.getInteractionMatrix(false);
	...
	public static long methodB() {
		...
		double[][] a = MySQLMatrix10000.getInteractionMatrix(false);
