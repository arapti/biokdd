...
public class MarkovClustering6000 {
	...
	public static long methodA() {
		...
		double[][] a = RDFLoad6000.getInteractionMatrix(false);
	...
	public static long methodB() {
		...
		double[][] a = MySQLMatrix6000.getInteractionMatrix(false);
