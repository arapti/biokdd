...
import com.jena.model.RDFLoad4000;
import com.vaannila.protein.MySQLMatrix2000;
import com.vaannila.protein.MySQLMatrix4000;
import com.vaannila.protein.Protein;

public class MarkovClustering4000 {
	/**
	...
	public static void main(String[] args) {
		...
		System.out.println("RDF Time " + a/10);
		System.out.println("RDBMS Time " + b/10);
		System.out.println("RDBMS Time+Hibernate " + c/10);
	...
	public static long methodA() {
		...
		double[][] a = RDFLoad4000.getInteractionMatrix(false);
	...
	public static long methodB() {
		...
		double[][] a = MySQLMatrix4000.getInteractionMatrix(false);
